...
# Define alarm sound frequency and duration
ALARM_FREQUENCY = 1000  # Hz
ALARM_DURATION = 3000  # milliseconds
...
def start_fall_detector_realtime(input_path = 0):
    ...
    fall_frames_seen = 0 # Number of consecutive fall frames seen so far
    fall_detected = False
    MIN_NUM_FALL_FRAME = 10 #int(fps/5) # Need at least some number of frames to avoid flickery classifications
...
if __name__ == "__main__":
    start_fall_detector_realtime("C:\\Users\\Admin\\Desktop\\FINAL YEAR PROJECT\\video_3.mp4")
    ...
    #start_fall_detector_realtime("datasets/FDD/Office/Videos/video (1).avi")
